...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.textEdit.textChanged.connect(self.textEditedEvent)
        ...
        newButton.triggered.connect(lambda: self.openNoteSlot(True))
        fileMenu.addAction(newButton)

        openButton = QAction('Open...', self)
        openButton.setShortcut('Ctrl+O')
        openButton.triggered.connect(lambda: self.openNoteSlot(False))
        ...
        cutButton.triggered.connect(self.textEdit.cut)
        ...
        copyButton.triggered.connect(self.textEdit.copy)
        ...
        # pasteButton.triggered.connect(self.textEdit.paste)
        ...
        selectButton.triggered.connect(self.textEdit.selectAll)
        ...
        self.fontsize.currentIndexChanged[str].connect(
            lambda s: self.textEdit.setFontPointSize(float(s)))
        ...
        self.aln_left_action.triggered.connect(
            lambda: self.textEdit.setAlignment(Qt.AlignLeft))
        ...
        self.aln_center_action.triggered.connect(
            lambda: self.textEdit.setAlignment(Qt.AlignCenter))
        ...
        self.aln_right_action.triggered.connect(
            lambda: self.textEdit.setAlignment(Qt.AlignRight))
        ...
        self.aln_justify_action.triggered.connect(
            lambda: self.textEdit.setAlignment(Qt.AlignJustify))
